...
.PHONY: gen
gen: ## Run go generate against code.
	go generate ./...
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name scanner-operator2-builder
	$(CONTAINER_TOOL) buildx use scanner-operator2-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm scanner-operator2-builder
	rm Dockerfile.cross
